...
const message = `🤖 *${process.env.BOT_USERNAME || 'Berxwedan Bot'}*'a hoş geldiniz! 🛡️ Bu bot grup moderasyonu için geliştirilmiştir. 📋 Komutlar: /help - Komutlar listesi /admin - Admin paneli /start - Bu mesaj`;
...
const info = `🤖 *Berxwedan Bot* ━━━━━━━━━━━━━━━━━━ 📌 Versiyon: 1.1.0 👨‍💼 Amaç: Grup Moderasyonu ✨ *Özellikler:* ✅ Ban/Unban sistemi ✅ Warn sistemi ✅ Mute/Unmute ✅ Kick sistemi ✅ İşlem günlüğü ✅ @kullanıcıadı & ID desteği 📞 *Destek:* @canbedran356`;
...
const welcomeMsg = `🎉 *Hoş Geldiniz!* 🎉 ━━━━━━━━━━━━━━━━━━ 👋 ${member.first_name}, gruba hoş geldiniz! 📋 *Grup Kuralları:* 1️⃣ Saygılı olun 2️⃣ İçerik paylaşırken kurallara uyun 3️⃣ Bot komutlarını spam yapmayın 🤝 İyi zamanlar dileriz!`;
...
await ctx.reply(`⚠️ Uyarı verildi (${user?.warnings || '?'}/3). Sebep: ${reason}`);
} else if (action === ‘mute’) {
